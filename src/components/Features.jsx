...
export default function Features() {
  ...
  return (
    <section className={`py-16 px-4 w-full transition-all duration-300 ease-in-out
      ...
      <div className="max-w-7xl mx-auto text-center border border-gray-300 dark:border-transparent dark:bg-gradient-to-r dark:from-indigo-600 dark:to-purple-600 dark:p-[2px] rounded-3xl">
        {/* Enhanced inner div */}
        <div className={`rounded-3xl p-10 shadow-lg transition-all duration-300 ease-in-out
          ${theme === 'light'
              ...
              <div 
                ...
                className={`feature-card flex-1 min-w-[350px] max-w-[450px] rounded-2xl p-8 shadow-lg transition-all duration-300 ease-in-out
                  ${theme === 'light' 
                    ...
                    : 'bg-gradient-to-r from-indigo-600 to-purple-600 text-gray-200 shadow-lg shadow-indigo-500/20'}`}
              >
                {/* Icon */}
